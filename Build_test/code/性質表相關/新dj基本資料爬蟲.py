...
for a in range(len(etf)):
    ...
    sql1 = "UPDATE detail SET 投資區域 = '"+ area[a] +"' WHERE name = '" +etf[a]+"'; "
    print(sql1)
    
    sql2 = "UPDATE detail SET 投資標的 = '"+ buy_type[a] +"' WHERE name = '" +etf[a]+"'; "
    print(sql2)
    
    sql3 = "UPDATE detail SET 配息頻率 = '"+ interest_freq[a] +"' WHERE name = '" +etf[a]+"'; "
    print(sql3)
    
    sql5 = "UPDATE detail SET 總費用率 = '"+ ccost[a] +"' WHERE name = '" +etf[a]+"';"
    print(sql5)
    
    sql6 = "UPDATE detail SET 追蹤指數 = '"+ trace_index[a] +"' WHERE name = '" +etf[a]+"'; "
    print(sql6)
    
    sql7 = "UPDATE detail SET 基準指數 = '"+ base_index[a] +"' WHERE name = '" +etf[a]+"';"
    print(sql7)

    sql8 = "UPDATE detail SET 投資風格 = '"+ style[a] +"' WHERE name = '" +etf[a]+"';"
    print(sql8)
