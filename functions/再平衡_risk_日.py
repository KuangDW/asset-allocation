...
input_money_record=[]
input_money_record.append(float(result_select[0][9]))
money_record = []
money_record.append( float(result_select[0][9]))
ratio_record = []
ratio_record.append(weight)
every_money_record = []
every_money_record.append(first_input_total)
date_record = []
...
#while(start_date<todayyy):
while((final_date+ relativedelta(days=1))<todayyy):
# while((final_date)<todayyy):
    ...
    # money_record.append(sum_of_final_money)    
    ...
    ratio_record.append(after_adj_ratio)
    every_money_record.append(new_asset)
...
# plt.plot(date_record,money_record)
# plt.show()

r=[]
for a in range(len(etf)):
    ratios=[]
    for i in range(len(ratio_record)):
        ratios.append(ratio_record[i][a])
    # plt.plot(date_record,ratios)
    r.append(ratios)
# plt.show()

# for a in range(len(etf)):
#     every_money=[]
#     for i in range(len(every_money_record)):
#         every_money.append(every_money_record[i][a])
#     plt.plot(every_money)
# plt.show()


# UPDATE user_data SET last_money = '20000  20000  20000  20000  20000  20000  20000  20000  20000  20000' WHERE name = 'max';
# %%
...
# str_data1 = 'C:/Users/User/Downloads/資產配置/再平衡日1.csv'
# str_data2 = 'C:/Users/User/Downloads/資產配置/再平衡日2.csv'
